...
let aa2mat aa =
  ...
  madd0 (Int.succ (Int.succ (Int.succ 0))) (Int.succ (Int.succ (Int.succ 0)))
    (madd0 (Int.succ (Int.succ (Int.succ 0))) (Int.succ (Int.succ (Int.succ 0)))
      (mat0 (Int.succ (Int.succ (Int.succ 0))))
      (mscal0 (Int.succ (Int.succ (Int.succ 0))) (Int.succ (Int.succ (Int.succ
        0))) (sin _UU03b8_) k))
    (mscal0 (Int.succ (Int.succ (Int.succ 0))) (Int.succ (Int.succ (Int.succ 0)))
      (rminus (iZR (Zpos XH)) (cos _UU03b8_))
...
let rz _UU03b8_ =
  l2m0 (Int.succ (Int.succ (Int.succ 0))) (Int.succ (Int.succ (Int.succ 0)))
    ...
    (sin _UU03b8_) :: ((cos _UU03b8_) :: ((iZR Z0) :: []))) :: (((iZR Z0) :: (
    (iZR Z0) :: ((iZR (Zpos XH)) :: []))) :: [])))
...
let s123 _UU03b8_1 _UU03b8_2 _UU03b8_3 =
  l2m0 (Int.succ (Int.succ (Int.succ 0))) (Int.succ (Int.succ (Int.succ 0)))
    (((RbaseSymbolsImpl.coq_Rmult (cos _UU03b8_2) (cos _UU03b8_3)) :: ((rminus
                                                                        (RbaseSymbolsImpl.coq_Rmult
                                                                        (RbaseSymbolsImpl.coq_Rmult
                                                                        (sin
                                                                        _UU03b8_1)
    ...
    (RbaseSymbolsImpl.coq_Rmult (cos _UU03b8_2) (sin _UU03b8_3)) :: ((RbaseSymbolsImpl.coq_Rplus
                                                                       (RbaseSymbolsImpl.coq_Rmult
                                                                        (RbaseSymbolsImpl.coq_Rmult
                                                                        (sin
                                                                        _UU03b8_1)
  ...
  l2v0 (Int.succ (Int.succ (Int.succ (Int.succ 0))))
    ((rminus
       (rminus
         ...
         (RbaseSymbolsImpl.coq_Rmult
           (q1
             (nat2finS (Int.succ (Int.succ (Int.succ 0))) (Int.succ (Int.succ 0))))
           (q2
             (nat2finS (Int.succ (Int.succ (Int.succ 0))) (Int.succ (Int.succ 0))))))
       (RbaseSymbolsImpl.coq_Rmult
         (q1
         ...
         (q2
           (nat2finS (Int.succ (Int.succ (Int.succ 0))) (Int.succ (Int.succ
             (Int.succ 0))))))) :: ((rminus
                                      ...
                                      (RbaseSymbolsImpl.coq_Rmult
                                        (q1
                                          (nat2finS (Int.succ (Int.succ (Int.succ
                                            0))) (Int.succ (Int.succ (Int.succ
                                            0)))))
                                        (q2
                                          (nat2finS (Int.succ (Int.succ (Int.succ
                                            0))) (Int.succ (Int.succ 0)))))) :: (
    (RbaseSymbolsImpl.coq_Rplus
      (RbaseSymbolsImpl.coq_Rplus
        (rminus
          (RbaseSymbolsImpl.coq_Rmult
    ...
    (RbaseSymbolsImpl.coq_Rplus
      ...
      (RbaseSymbolsImpl.coq_Rmult
        (q1
          (nat2finS (Int.succ (Int.succ (Int.succ 0))) (Int.succ (Int.succ
            (Int.succ 0))))) (q2 (nat2finS (Int.succ (Int.succ (Int.succ 0))) 0)))) :: []))))
...
let q2m q0 =
  ...
  let z0 =
    q0
      (nat2finS (Int.succ (Int.succ (Int.succ 0))) (Int.succ (Int.succ (Int.succ
        0))))
  in
  let (p0, y) = p in
  let (w, x) = p0 in
  l2m0 (Int.succ (Int.succ (Int.succ 0))) (Int.succ (Int.succ (Int.succ 0)))
    ...
    (RbaseSymbolsImpl.coq_Rplus
      ...
      (RbaseSymbolsImpl.coq_Rmult
        (RbaseSymbolsImpl.coq_Rmult (iZR (Zpos (XO XH))) w) z0)) :: ((rminus
                                                                       (RbaseSymbolsImpl.coq_Rplus
                                                                        (rminus
                                                                        (pow0 w
                                                                        (Int.succ
    ...
    (rminus
      (RbaseSymbolsImpl.coq_Rmult
        (RbaseSymbolsImpl.coq_Rmult (iZR (Zpos (XO XH))) y) z0)
      (RbaseSymbolsImpl.coq_Rmult
        (RbaseSymbolsImpl.coq_Rmult (iZR (Zpos (XO XH))) w) x)) :: []))) :: ((
    (rminus
      (RbaseSymbolsImpl.coq_Rmult
        (RbaseSymbolsImpl.coq_Rmult (iZR (Zpos (XO XH))) x) z0)
      (RbaseSymbolsImpl.coq_Rmult
    ...
    (RbaseSymbolsImpl.coq_Rplus
      (rminus
        (rminus (pow0 w (Int.succ (Int.succ 0))) (pow0 x (Int.succ (Int.succ 0))))
...
let rotx ang v =
  mmulv0 (Int.succ (Int.succ (Int.succ 0))) (Int.succ (Int.succ (Int.succ 0)))
    (rx ang) v
...
let rotByM m v =
  mmulv0 (Int.succ (Int.succ (Int.succ 0))) (Int.succ (Int.succ (Int.succ 0))) m v
...
let m2e m =
  l2v0 (Int.succ (Int.succ (Int.succ 0)))
    ((R2Euler_S123.Coq_alg2._UU03d5_' m) :: ((R2Euler_S123.Coq_alg2._UU03b8_' m) :: (
    (R2Euler_S123.Coq_alg2._UU03c8_' m) :: [])))
